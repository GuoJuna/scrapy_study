...
from scrapy_037_dangdang.items import Scrapy037DangdangItem
...
class DangSpider(scrapy.Spider):
    ...
    def parse(self, response):
        ...
        for li in li_list:
            ...
            # 第一张图片的src是可以使用, 其他图片的地址是data-original
            if src:
                src = src
            else:
            ...
            book = Scrapy037DangdangItem(src=src, name=name, price=price)
